...
public class Adapter_SelectedPhoto  extends BaseRecyclerViewAdapter<Uri, Adapter_SelectedPhoto.SelectedPhotoHolder> {
    ...
    com.mwongera.rento.ImagePickerActivity imagePickerActivity;

    public Adapter_SelectedPhoto(com.mwongera.rento.ImagePickerActivity imagePickerActivity, int closeImageRes) {
